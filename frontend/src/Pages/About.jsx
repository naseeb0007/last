...
function About() {
  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9 w-full border-l-2 border-r-2 border-gray-300">
      ...
      <p className="text-lg text-gray-800 mb-4 animate__animated animate__fadeIn animate__delay-2s">
        At Bobby Institute, we don't just teach, we inspire! We guide you through the complexities of international exams, helping you achieve a level of proficiency that opens doors to global opportunities. We pride ourselves on personalized coaching, flexible schedules, and a commitment to your success.
      </p>
      ...
      <p className="text-lg text-gray-700 mb-4 animate__animated animate__fadeIn animate__delay-3s">
        At Bobby Institute, our mission is to provide exceptional training and support to students and professionals, helping them achieve their dreams of studying and working abroad. We aim to be a bridge between ambition and accomplishment, ensuring every student reaches their full potential.
      </p>
      <p className="text-lg text-gray-700 mb-4 animate__animated animate__fadeIn animate__delay-3s">
      ...
      {/* Contact Section */}
      <h2 className="font-semibold text-blue-800 text-xl animate__animated animate__fadeIn animate__delay-7s">Contact Us</h2>
      <p className="text-lg text-gray-700 mb-4 animate__animated animate__fadeIn animate__delay-7s">
        Ready to embark on your journey to success? Get in touch with Bobby Institute today and take the first step toward achieving your dreams.
      </p>

      {/* Phone Input Section */}
      <div className="flex flex-col items-center mt-6">
        <label htmlFor="phone" className="text-lg font-semibold text-gray-700 mb-2">Enter Your Phone Number:</label>
        <input
          type="text"
          id="phone"
          value={phone}
          ...
          className="p-2 border border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600"
        />
